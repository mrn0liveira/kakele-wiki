...
import {
	detectLanguage,
	useServerTranslation as serverSideTranslation,
} from "@/src/lib/i18n";
	...
	return (
		<SessionProvider session={session}>
			<html lang={initialLanguage} suppressHydrationWarning>
				<body
					className={cn(poppins.className, "container-pattern bg-[#14110f]")}
				>
					<ClientSideProviders initialLanugage={initialLanguage}>
						<CookiesProvider>
							<div className="container flex min-h-screen flex-1 flex-col items-center justify-center px-2">
								...
								<AdModal
									text1={t("coinsHub.modal1")}
									text2={t("coinsHub.modal2")}
									text3={t("coinsHub.modal3")}
								/>
								<Footer />
							</div>
						</CookiesProvider>
