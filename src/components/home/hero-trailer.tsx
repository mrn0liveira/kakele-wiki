...
export default function HeroTrailer({ ad, mobileAd, subhead }: ComponentProps) {
  return (
    ...
    >
      ...
      >
        <source
          src='https://res.cloudinary.com/dl3asnoii/video/upload/v1713283739/kakele.com.br/home/trailer.mp4'
          type='video/mp4'
        />
        ...
        <div className='absolute bottom-12 z-10 flex w-full flex-row items-center justify-center gap-4 space-y-0 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]'>
          ...
          >
            <Image
              ...
              className='h-60 w-60'
              height={200}
              src='https://res.cloudinary.com/dl3asnoii/image/upload/v1714587997/kakele.com.br/general/dragon.png'
              width={200}
            />
          </motion.div>
