...
export default function EmojiCarousel() {
	...
	return (
		<div
			className={`carousel-container unselectable h-24 w-full ${styles.container}`}
		>
			<div>
						...
						{emojis.map((item, index) => (
							...
							>
								<Image
									...
									height={128}
									quality={100}
									src={`https://res.cloudinary.com/dbkrvt2x0/image/upload/v1715883412/kakele-wiki/emojis//${
