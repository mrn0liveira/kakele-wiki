...
import { InterestSelect } from "./select";
				...
				<form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
								...
								<FormItem>
									...
									<FormControl>
										<Input
											{...field}
											disabled={isPending}
											placeholder="Muroria's King"
											className="text-xs h-[1.5rem]"
										/>
									</FormControl>
									<FormMessage />
								</FormItem>
					...
					<Button
						className={cn(
							...
							"card-shine-effect border-b-large w-full rounded-md",
						)}
						disabled={isPending}
						type="submit"
					>
